...
void tester_exponentiation_document() {
    ...
    BigBinary N = creerBigBinaryDepuisChaine(
        ""
    );
    printf("N = ");
    afficheBigBinary(N);
    printf("   (modulus RSA)\n");
    ...
    BigBinary A = creerBigBinaryDepuisChaine(
        "10100011000010111111011001110010101101100100111110001101000001001111000000110000111010111010111001110001000000000111000100001011110101001111100110111100000110100100110110110010111000101101001011110100011011010110110111100000000110100100111111000111100110"
    );
    printf("\nA = ");
    afficheBigBinary(A);
    printf("   (base)\n");
...
void tester_rsa_exemple_jouet() {
    ...
    // N = 1211809 = (100100111110110100001)₂
    BigBinary N = creerBigBinaryDepuisChaine("100100111110110100001");
    printf("\nN = ");
    afficheBigBinary(N);
    ...
    // D = 251501 = (111101011001101101)₂
    BigBinary D = creerBigBinaryDepuisChaine("111101011001101101");
    printf("\n--- DÉCHIFFREMENT ---\n");
